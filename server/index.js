...
//Database connection
const connectString =
  "mongodb+srv://user1:mypassword@postitcluster.shtwyrn.mongodb.net/postITDb?appName=PostITCluster";
  ...
  try {
    ...
    if (userIndex !== -1) {
      ...
      const udpatedPost = await PostModel.findOneAndUpdate(
        ...
        {
          $inc: { "likes.count": -1 },
          // Decrement the like count $inc and $pull are update operators
